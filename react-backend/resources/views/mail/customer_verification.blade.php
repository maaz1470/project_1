																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								<!-- <tr>
																									<td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
																										<img src="../images/img_intro_2.png" width="253" height="300" border="0" alt="" />
																									</td>
																								</tr> -->
																								<tr>
																									<td  class="title-36 a-center pb-15" style="font-size:28px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 30px; ">
																										...
																										<table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
																											<tr>
																												<td class="btn-16 c-white l-white" bgcolor="#f3189e" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
																													<a href="{{ $home_url . '/' . 'verify-customer/' . $token}}" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																														<span class="link c-white" style="text-decoration:none; color:#ffffff;">Verify Now</span>
																													</a>
																												</td>
																												<td>
																													<a href="{{ $home_url . '/' . 'verify-customer/' . $token}}" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																														<span class="link c-white" style="text-decoration:underline; color:blue;">{{ $home_url . '/' . 'verify-customer/' . $token}}</span>
																													</a>
																												</td>
																											</tr>
																										</table>
