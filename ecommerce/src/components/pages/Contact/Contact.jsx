            ...
            <div className="container py-14">
                <div className="grid grid-cols-12 gap-6">
                    <div className="col-span-12 lg:col-span-7 bg-white box_shadow px-[30px] py-[24px]">
                        <div>
                            <h4 className="text-[20px] sm:text-[28px] uppercase mb-1">Leave us a message</h4>
                            <p className="mb-6 text-[15px]">Use the form below to get in touch with the sales team</p>
                            <div className="grid grid-cols-12 gap-5">
                                <div className="col-span-12 sm:col-span-6">
                                    <div>
                                        <label for="first_name" className="block mb-1.5">First Name <span
                                                className="text-[#fd3d57ad]">*</span></label>
                                        <input type="text"
                                            className="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0" />
                                    </div>
                                </div>
                                <div className="col-span-12 sm:col-span-6">
                                    <div className="single_billing_inp">
                                        <label for="last_name" className="block mb-1.5">Last Name <span
                                                className="text-[#fd3d57ad]">*</span></label>
                                        <input type="text"
                                            className="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0" />
                                    </div>
                                ...
                                <div className="col-span-12">
                                    <div className="single_billing_inp">
                                        <label for="email_addr" className="block mb-1.5">Email Address <span
                                                className="text-[#fd3d57ad]">*</span></label>
                                        <input type="text"
                                            className="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0" />
                                    </div>
                                ...
                                <div className="col-span-12">
                                    <div className="single_billing_inp">
                                        <label for="company_name" className="block mb-1.5">Subject</label>
                                        <input type="text"
                                            className="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0" />
                                    </div>
                                </div>
                                <div className="col-span-12">
                                    <div className="single_billing_inp">
                                        <label for="county_region" className="block mb-1.5">Your message <span
                                                className="text-[#fd3d57ad]">*</span></label>
                                        <textarea type="text"
                                            className="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0" />
                                    </div>
                                ...
                                <div className="col-span-12 mt-4">
                                    <button type="submit" className="bg-primary border border-primary text-white px-8 py-3 font-medium    rounded-md hover:bg-transparent hover:text-primary">send message</button>
                                </div>
                        ...
                        <div className="padding_default border-0 shadow_sm">
                            ...
                            <div className="footer_contact">
                                <div className="relative pb-3">
                                    ...
                                    <p className="pl-[32px]"> 7895 Dr New Albuquerue, NM 19800, nited
                                        States Of America </p>
                                </div>
                                <div className="relative pb-3">
                            ...
                            <p className="text_md mb-0">If you are interesting in emplyment <br /> opportunities at RAFCARTs. Please
                                email us :
                            </p>
                            <a href="#" className="text-primary">contact@mail.com</a>
