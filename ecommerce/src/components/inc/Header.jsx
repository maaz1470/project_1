                                ...
                                <div
                                    ...
                                    <div className="flex mt-4 gap-4">
                                        <Link to="/cart"
                                            ...
                                            CART</Link>
                                        <a href="#"
                                            className="w-1/2 rounded-[3px] py-2 px-2.5 border border-primary hover:bg-primary bg-white hover:text-white inline-block text-center text-sm text-primary transition duration-300">CHECKOUT</a>
                                    </div>
                                </div>
                            </div>
                            <div className="relative group py-2">
                                <a href="#" className="relative block text-center ml-5">
                                    <span className="text-secondary flex justify-center"><svg width="28" height="28"
                                            viewBox="0 0 256 256">
                                            <path fill="currentColor"
