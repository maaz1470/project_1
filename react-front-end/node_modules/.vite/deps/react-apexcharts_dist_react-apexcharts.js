...
var Charts = class extends import_react.Component {
  constructor(props) {
    super(props);
    if (import_react.default.createRef) {
      this.chartRef = import_react.default.createRef();
    } else {
  ...
  render() {
    ...
    return import_react.default.createElement("div", {
      ref: import_react.default.createRef ? this.chartRef : this.setRef,
      ...props
    });
  }
  componentDidMount() {
    const current = import_react.default.createRef ? this.chartRef.current : this.chartRef;
    this.chart = new import_apexcharts.default(current, this.getConfig());
    this.chart.render();
  }
  getConfig() {
...
Charts.propTypes = {
  ...
  width: import_prop_types.default.any,
  height: import_prop_types.default.any,
...
apexcharts/dist/apexcharts.common.js:
   ...
   *)
*/
//# sourceMappingURL=react-apexcharts_dist_react-apexcharts.js.map
